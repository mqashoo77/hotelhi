...
public class HotelService {
    ...
    public static Hotel getHotelById(int id){
        Hotel hotel=new Hotel( "Hilton London Metropole", "225 Edgware Road", "London", 2, "info@hiltonlondonmet.com",1, "main_image_a.jpg", "Hilton London Metropole", 2, "+55 20 7402 4141", 8.4);
        return hotel;
    }
